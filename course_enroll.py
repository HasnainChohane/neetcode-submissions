...
both_courses = sorted(python_students.intersection(web_students))
all_students = sorted(python_students.union(web_students))
python_only = sorted(python_students.difference(web_students))
